...
export const Search:FC<Props> = ({color='#414141', width='50', height='50', p=true}) => {
  return (
    <svg width={width} height={width}  style={{paddingBottom:p ?'5px': 0}} viewBox="0 0 25 16"  xmlns="http://www.w3.org/2000/svg">
